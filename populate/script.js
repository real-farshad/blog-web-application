...
function getArticlesList() {
    ...
    for (article of mockData) {
        const { title, imageURL, thumbnailURL, description, category, viewCount, commentCount } = article;
        articles.push({ title, imageURL, thumbnailURL, description, category, viewCount, commentCount });
    }
    return articles;
}
